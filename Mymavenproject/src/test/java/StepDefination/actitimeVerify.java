...
public class actitimeVerify extends SeleniumUtility {
    ...
    @Then("verify that actitime page open with with title")
    public void verify_that_actitime_page_open_with_with(String title) {
    	setSleepTime(2000);
    	Assert.assertEquals(driver.getTitle(), title, "actiTIME - Enter Time-Track\", \"Either login is not successful or page not loaded ");
